...
function mod:UNIT_HEALTH_FREQUENT(unit)
	...
	if hp < 90 and hp90 == false then
		self:Message(-15076, "Attention", "Info", CL.spawned:format(self:SpellName(-15076)))
		hp90 = true
	elseif hp <= 55 and hp55 == false then
		self:Message(-15076, "Important", "Alarm", CL.incoming:format(self:SpellName(-15076)))
		hp55 = true
	elseif hp < 50 and hp50 == false then
		self:Message(-15076, "Attention", "Info", CL.spawned:format(self:SpellName(-15076)))
		self:CDBar(238315, 8)
		hp50 = true
